...
ALTER DEFAULT PRIVILEGES IN SCHEMA attrs GRANT SELECT ON SEQUENCES TO readonly;
ALTER DEFAULT PRIVILEGES IN SCHEMA crops GRANT SELECT ON SEQUENCES TO readonly;
ALTER DEFAULT PRIVILEGES IN SCHEMA attrs GRANT SELECT ON SEQUENCES TO readonly;
